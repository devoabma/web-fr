...
export function PrintersNotice() {
  return (
    <div className="hidden items-start gap-3 rounded-xl border border-amber-500/30 bg-amber-500/8 p-4 sm:flex">
      ...
      <div className="flex flex-col gap-1.5 text-muted-foreground text-sm leading-relaxed">
        <p>
          ...
          <strong className="font-semibold text-foreground">toda sexta-feira às 23:59</strong>. Esta tela mostra apenas o que foi
          impresso desde a última limpeza — o que precisar ser guardado deve ser baixado antes disso.
        </p>

        <p>
          Você enxerga as impressões das{' '}
