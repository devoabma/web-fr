  ...
  return (
    ...
    >
      ...
      <div
        ...
        data-side={side}
        className={cn(
          'fixed top-(--sidebar-offset) bottom-0 z-10 hidden h-[calc(100svh-var(--sidebar-offset))] w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear data-[side=right]:right-0 data-[side=left]:left-0 data-[side=right]:group-data-[collapsible=offcanvas]:-right-(--sidebar-width) data-[side=left]:group-data-[collapsible=offcanvas]:-left-(--sidebar-width) md:flex',
